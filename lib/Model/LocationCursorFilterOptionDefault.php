...
/**
 * LocationCursorFilterOptionDefault Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LocationCursorFilterOptionDefault implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'location.CursorFilterOptionDefault';
     ...
     * Sets capacities
     *
     * @param int[]|null $capacities capacities
     *
     * @return self
     */
    ...
    public function setSearchString($search_string)
    {
        ...
        if ((mb_strlen($search_string) < 3)) {
            throw new \InvalidArgumentException('invalid length for $search_string when calling LocationCursorFilterOptionDefault., must be bigger than or equal to 3.');
        }
