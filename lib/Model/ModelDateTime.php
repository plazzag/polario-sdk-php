...
/**
 * ModelDateTime Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelDateTime implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model.DateTime';
    ...
    */
     ...
     * Sets date_end
     *
     * @param string|null $date_end either dateStart or dateEnd must be set
     *
     * @return self
     */
     ...
     * Sets date_start
     *
     * @param string|null $date_start either dateStart or dateEnd must be set
     *
     * @return self
     */
     ...
     * Sets time_start
     *
     * @param string|null $time_start null = deadline or all day
     *
     * @return self
     */
