<?php
/**
 * GamificationleaderboardResponseAdmin
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GamificationleaderboardResponseAdmin Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GamificationleaderboardResponseAdmin implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'gamificationleaderboard.ResponseAdmin';
     ...
     * Sets group_ids
     *
     * @param string[]|null $group_ids null for all accounts, empty array for no accounts
     *
     * @return self
     */
