...
/**
 * JobCursorRequestAdmin Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class JobCursorRequestAdmin implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'job.CursorRequestAdmin';
    ...
    protected static $openAPITypes = [
        'filter' => '\OpenAPI\Client\Model\JobCursorFilterOptionAdmin',
     ...
     * Gets filter
     *
     * @return \OpenAPI\Client\Model\JobCursorFilterOptionAdmin|null
     */
     ...
     * Sets filter
     *
     * @param \OpenAPI\Client\Model\JobCursorFilterOptionAdmin|null $filter filter
     *
     * @return self
     */
     ...
     * Sets sort
     *
     * @param array<string,string>[]|null $sort only one property per entry allowed; property enums: `\"id\"` `\"lastModified\"` `\"projectId\"` `\"status\"` `\"title\"` `\"triggerCron\"` `\"triggerEvent\"`; value enums: `\"ASC\"` `\"DESC\"`
     *
     * @return self
     */
