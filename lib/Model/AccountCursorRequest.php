...
/**
 * AccountCursorRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountCursorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'account.CursorRequest';
    ...
    protected static $openAPITypes = [
        'filter' => '\OpenAPI\Client\Model\AccountCursorFilterOption',
     ...
     * Gets filter
     *
     * @return \OpenAPI\Client\Model\AccountCursorFilterOption|null
     */
     ...
     * Sets filter
     *
     * @param \OpenAPI\Client\Model\AccountCursorFilterOption|null $filter filter
     *
     * @return self
     */
     ...
     * Sets sort
     *
     * @param array<string,string>[]|null $sort only one property per entry allowed; property enums: `\"creationTimestamp\"` `\"email\"` `\"firstLoginTimestamp\"` `\"firstName\"` `\"id\"` `\"lastModified\"` `\"lastName\"` `\"lastSessionTimestamp\"` `\"salutation\"` `\"title\"` `\"tracking\"` `\"type\"`; value enums: `\"ASC\"` `\"DESC\"`
     *
     * @return self
     */
