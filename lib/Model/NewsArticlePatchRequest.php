...
/**
 * NewsArticlePatchRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NewsArticlePatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'news.ArticlePatchRequest';
    ...
    */
     ...
     * Sets archived_at
     *
     * @param int|null $archived_at not editable for status `\"Archived\"`; If not null must be must greater than `publishedAt` and in future for status `\"Draft\"` and `\"Published\"`
     *
     * @return self
     */
     ...
     * Sets published_at
     *
     * @param int|null $published_at not editable for status `\"Published\"`; If not null must be in future for status `\"Draft\"` and in past for status `\"Archived\"`
     *
     * @return self
     */
     ...
     *
     * @param bool|null $send_notification value can not be changed for published or archived news
     *
     * @return self
     */
