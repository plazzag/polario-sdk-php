...
/**
 * GroupPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GroupPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'group.PatchRequest';
    ...
    */
    ...
    public function setPosition($position)
    {
        ...
        if (($position < 0)) {
            throw new \InvalidArgumentException('invalid value for $position when calling GroupPatchRequest., must be bigger than or equal to 0.');
        }
