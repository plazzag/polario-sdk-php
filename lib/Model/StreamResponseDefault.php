...
/**
 * StreamResponseDefault Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StreamResponseDefault implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'stream.ResponseDefault';
    ...
    protected static $openAPITypes = [
        'alt_text' => 'string',
        'id' => 'string',
        'output' => '\OpenAPI\Client\Model\StreamOutput',
        'placeholder' => 'string',
        'project_id' => 'string',
        'title' => 'string',
        'translations' => '\OpenAPI\Client\Model\ModelStreamTranslation[]'
    ];
    ...
    */
     ...
     * Gets output
     *
     * @return \OpenAPI\Client\Model\StreamOutput|null
     */
     ...
     * Sets output
     *
     * @param \OpenAPI\Client\Model\StreamOutput|null $output output
     *
     * @return self
     */
     ...
     * Gets translations
     *
     * @return \OpenAPI\Client\Model\ModelStreamTranslation[]|null
     */
     ...
     * Sets translations
     *
     * @param \OpenAPI\Client\Model\ModelStreamTranslation[]|null $translations translations
     *
     * @return self
     */
