 ...
 */
class ModelSSOIdp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model.SSOIdp';
    ...
    */
     ...
     * Sets crt
     *
     * @param string|null $crt the crt provided from the idp
     *
     * @return self
     */
     ...
     * Sets entity_id
     *
     * @param string|null $entity_id the entity id provided from the idp
     *
     * @return self
     */
     ...
     * Sets login_url
     *
     * @param string|null $login_url the login url to start the auth flow
     *
     * @return self
     */
    public function setLoginUrl($login_url)
    {
        if (is_null($login_url)) {
            array_push($this->openAPINullablesSetToNull, 'login_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('login_url', $nullablesSetToNull);
            if ($index !== FALSE) {
