...
/**
 * SurveyparticipationResponseAdmin Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SurveyparticipationResponseAdmin implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'surveyparticipation.ResponseAdmin';
     ...
     * Sets answer_id
     *
     * @param string|null $answer_id answer_id
     *
     * @return self
     */
    public function setAnswerId($answer_id)
    {
        if (is_null($answer_id)) {
            array_push($this->openAPINullablesSetToNull, 'answer_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('answer_id', $nullablesSetToNull);
            if ($index !== FALSE) {
