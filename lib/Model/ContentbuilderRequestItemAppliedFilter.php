...
/**
 * ContentbuilderRequestItemAppliedFilter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentbuilderRequestItemAppliedFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'contentbuilder.RequestItemAppliedFilter';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['period']) && (count($this->container['period']) > 1)) {
            $invalidProperties[] = "invalid value for 'period', number of items must be less than or equal to 1.";
        }
    ...
    public function setPeriod($period)
    {
        ...
        if ((count($period) > 1)) {
            throw new \InvalidArgumentException('invalid value for $period when calling ContentbuilderRequestItemAppliedFilter., number of items must be less than or equal to 1.');
        }
