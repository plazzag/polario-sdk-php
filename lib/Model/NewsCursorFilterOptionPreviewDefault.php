...
/**
 * NewsCursorFilterOptionPreviewDefault Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NewsCursorFilterOptionPreviewDefault implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'news.CursorFilterOptionPreviewDefault';
    ...
    public function setSearchString($search_string)
    {
        ...
        if ((mb_strlen($search_string) < 3)) {
            throw new \InvalidArgumentException('invalid length for $search_string when calling NewsCursorFilterOptionPreviewDefault., must be bigger than or equal to 3.');
        }
