...
/**
 * LocationreservationRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LocationreservationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'locationreservation.Request';
    ...
    public function setDuration($duration)
    {
        ...
        if (($duration < 1)) {
            throw new \InvalidArgumentException('invalid value for $duration when calling LocationreservationRequest., must be bigger than or equal to 1.');
        }
