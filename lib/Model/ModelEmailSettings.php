...
/**
 * ModelEmailSettings Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelEmailSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model.EmailSettings';
    ...
    */
    ...
    public function setReplyToAddress($reply_to_address)
    {
        if (is_null($reply_to_address)) {
            array_push($this->openAPINullablesSetToNull, 'reply_to_address');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reply_to_address', $nullablesSetToNull);
            if ($index !== FALSE) {
