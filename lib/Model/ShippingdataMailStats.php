...
/**
 * ShippingdataMailStats Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ShippingdataMailStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'shippingdata.MailStats';
    ...
    public const STATUS_FURTHER_ATTEMPT = 'FurtherAttempt';
    public const STATUS_IN_QUEUE = 'InQueue';
    ...
    {
        $this->setIfExists('mail_sent', $data ?? [], null);
     ...
     * Sets mail_sent
     *
     * @param bool|null $mail_sent mail_sent
     *
     * @return self
     */
    public function setMailSent($mail_sent)
    {
        if (is_null($mail_sent)) {
            throw new \InvalidArgumentException('non-nullable mail_sent cannot be null');
        }
