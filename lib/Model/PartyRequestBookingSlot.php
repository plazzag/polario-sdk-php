...
/**
 * PartyRequestBookingSlot Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PartyRequestBookingSlot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'party.RequestBookingSlot';
    ...
    */
     ...
     * Sets is_visible
     *
     * @param bool|null $is_visible if false the available booking period should not be displayed; Default: `false`
     *
     * @return self
     */
