...
/**
 * ModelAccountDevice Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelAccountDevice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model.AccountDevice';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('login_timestamp', $data ?? [], null);
    ...
    */
     ...
     *
     * @param int|null $login_timestamp login_timestamp
     *
     * @return self
     */
    public function setLoginTimestamp($login_timestamp)
    {
        if (is_null($login_timestamp)) {
            throw new \InvalidArgumentException('non-nullable login_timestamp cannot be null');
        }
