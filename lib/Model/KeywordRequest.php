...
class KeywordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'keyword.Request';
    ...
    protected static $openAPIFormats = [
        ...
        'background_color_dark' => 'optional',
    ...
    */
     ...
     *
     * @param string|null $background_color hexcolor or enum: `\"backgroundPrimary\"` `\"backgroundSecondary\"` `\"backgroundTertiary\"` `\"border\"` `\"contrast\"` `\"error\"` `\"primary\"` `\"secondary\"` `\"success\"` `\"textPrimary\"` `\"textSecondary\"`; Default: `null`
     *
     * @return self
     */
     ...
     *
     * @param string|null $background_color_dark hexcolor or enum: `\"backgroundPrimary\"` `\"backgroundSecondary\"` `\"backgroundTertiary\"` `\"border\"` `\"contrast\"` `\"error\"` `\"primary\"` `\"secondary\"` `\"success\"` `\"textPrimary\"` `\"textSecondary\"`; Default: `null`
     *
     * @return self
     */
     ...
     * Sets category_id
     *
     * @param string|null $category_id Default: `null`
     *
     * @return self
     */
     ...
     * Sets project_id
     *
     * @param string|null $project_id Deprecated: will be removed in 6.0; must be `null`
     *
     * @return self
     */
