...
/**
 * DirectoryCursorFilterOptionAdmin Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DirectoryCursorFilterOptionAdmin implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'directory.CursorFilterOptionAdmin';
    ...
    public function setSearchString($search_string)
    {
        ...
        if ((mb_strlen($search_string) < 3)) {
            throw new \InvalidArgumentException('invalid length for $search_string when calling DirectoryCursorFilterOptionAdmin., must be bigger than or equal to 3.');
        }
