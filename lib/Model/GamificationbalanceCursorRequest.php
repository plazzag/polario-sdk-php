...
/**
 * GamificationbalanceCursorRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GamificationbalanceCursorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'gamificationbalance.CursorRequest';
    ...
    protected static $openAPITypes = [
        'filter' => '\OpenAPI\Client\Model\GamificationbalanceCursorFilterOption',
     ...
     * Gets filter
     *
     * @return \OpenAPI\Client\Model\GamificationbalanceCursorFilterOption|null
     */
     ...
     * Sets filter
     *
     * @param \OpenAPI\Client\Model\GamificationbalanceCursorFilterOption|null $filter filter
     *
     * @return self
     */
     ...
     * Sets sort
     *
     * @param array<string,string>[]|null $sort only one property per entry allowed; property enums: `\"accountId\"` `\"action\"` `\"gainedAt\"` `\"id\"` `\"leaderboardId\"` `\"objectId\"` `\"objectType\"` `\"projectId\"` `\"referenceId\"` `\"ruleId\"` `\"value\"`; value enums: `\"ASC\"` `\"DESC\"`
     *
     * @return self
     */
