...
class LocalizationCursorFilterOptionAdmin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSearchString($search_string)
    {
        ...
        if ((mb_strlen($search_string) < 3)) {
            throw new \InvalidArgumentException('invalid length for $search_string when calling LocalizationCursorFilterOptionAdmin., must be bigger than or equal to 3.');
        }
