...
/**
 * LocationCursorFilterOptionAdmin Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LocationCursorFilterOptionAdmin implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'location.CursorFilterOptionAdmin';
    ...
    public function setSearchString($search_string)
    {
        ...
        if ((mb_strlen($search_string) < 3)) {
            throw new \InvalidArgumentException('invalid length for $search_string when calling LocationCursorFilterOptionAdmin., must be bigger than or equal to 3.');
        }
