<?php
/**
 * GamificationbalancePostBonusRequest
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GamificationbalancePostBonusRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GamificationbalancePostBonusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'gamificationbalance.PostBonusRequest';
     ...
     * Sets bonus
     *
     * @param int|null $bonus must be not 0
     *
     * @return self
     */
