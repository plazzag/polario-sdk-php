<?php
/**
 * GamificationleaderboardentryCursorRequestAdmin
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GamificationleaderboardentryCursorRequestAdmin Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GamificationleaderboardentryCursorRequestAdmin implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'gamificationleaderboardentry.CursorRequestAdmin';
    ...
    protected static $openAPITypes = [
        'filter' => '\OpenAPI\Client\Model\GamificationleaderboardentryCursorFilterOptionAdmin',
     ...
     * Gets filter
     *
     * @return \OpenAPI\Client\Model\GamificationleaderboardentryCursorFilterOptionAdmin|null
     */
     ...
     * Sets filter
     *
     * @param \OpenAPI\Client\Model\GamificationleaderboardentryCursorFilterOptionAdmin|null $filter filter
     *
     * @return self
     */
     ...
     * Sets sort
     *
     * @param array<string,string>[]|null $sort only one property per entry allowed; property enums: `\"accountId\"` `\"leaderboardId\"` `\"projectId\"` `\"rank\"` `\"score\"`; value enums: `\"ASC\"` `\"DESC\"`
     *
     * @return self
     */
