...
/**
 * KeywordResponseAdmin Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class KeywordResponseAdmin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'keyword.ResponseAdmin';
    ...
    */
     ...
     * Sets project_id
     *
     * @param string|null $project_id Deprecated: will be removed in 6.0; will be always `null`
     *
     * @return self
     */
