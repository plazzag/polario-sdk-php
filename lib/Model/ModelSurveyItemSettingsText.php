...
/**
 * ModelSurveyItemSettingsText Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelSurveyItemSettingsText implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'model.SurveyItemSettingsText';
    ...
    public function setMaxLength($max_length)
    {
        ...
        if (!is_null($max_length) && ($max_length < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_length when calling ModelSurveyItemSettingsText., must be bigger than or equal to 1.');
        }
