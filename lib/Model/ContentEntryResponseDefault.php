...
/**
 * ContentEntryResponseDefault Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContentEntryResponseDefault implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'content.EntryResponseDefault';
     ...
     * Sets widgets
     *
     * @param array<string,object>|null $widgets map[string]contentbuilder.ResponseItem
     *
     * @return self
     */
