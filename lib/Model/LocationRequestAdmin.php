...
class LocationRequestAdmin implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets capacity
     *
     * @param int|null $capacity null if no limit should apply; Default: `null`
     *
     * @return self
     */
    public function setCapacity($capacity)
    {
        ...
        if (($capacity < 1)) {
            throw new \InvalidArgumentException('invalid value for $capacity when calling LocationRequestAdmin., must be bigger than or equal to 1.');
        }
