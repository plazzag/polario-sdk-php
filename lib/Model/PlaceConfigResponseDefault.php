...
/**
 * PlaceConfigResponseDefault Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PlaceConfigResponseDefault implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'place.ConfigResponseDefault';
    ...
    protected static $setters = [
        'google_places_api_key' => 'setGooglePlacesApiKey'
    ];
    ...
    {
        $this->setIfExists('google_places_api_key', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets google_places_api_key
     *
     * @return string|null
     */
    public function getGooglePlacesApiKey()
    {
        return $this->container['google_places_api_key'];
    }

    /**
     * Sets google_places_api_key
     *
     * @param string|null $google_places_api_key google_places_api_key
     *
     * @return self
     */
    public function setGooglePlacesApiKey($google_places_api_key)
    {
        if (is_null($google_places_api_key)) {
            throw new \InvalidArgumentException('non-nullable google_places_api_key cannot be null');
        }
        $this->container['google_places_api_key'] = $google_places_api_key;
