...
/**
 * SurveyanswerResponseAdmin Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SurveyanswerResponseAdmin implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'surveyanswer.ResponseAdmin';
    ...
    protected static $openAPITypes = [
        'answers' => 'array<string,\OpenAPI\Client\Model\ModelSurveyParticipationAnswer>',
        'id' => 'string',
        'project_id' => 'string',
        'survey_id' => 'string'
    ];
     ...
     * Gets answers
     *
     * @return array<string,\OpenAPI\Client\Model\ModelSurveyParticipationAnswer>|null
     */
     ...
     * Sets answers
     *
     * @param array<string,\OpenAPI\Client\Model\ModelSurveyParticipationAnswer>|null $answers answers
     *
     * @return self
     */
