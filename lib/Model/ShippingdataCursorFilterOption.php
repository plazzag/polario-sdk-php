<?php
/**
 * ShippingdataCursorFilterOption
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ShippingdataCursorFilterOption Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ShippingdataCursorFilterOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'shippingdata.CursorFilterOption';
     ...
     * Sets shipping_ids
     *
     * @param string[]|null $shipping_ids multiple ids must share the same object type
     *
     * @return self
     */
