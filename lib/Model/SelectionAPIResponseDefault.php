...
/**
 * SelectionAPIResponseDefault Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelectionAPIResponseDefault implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'selection.APIResponseDefault';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'options' => '\OpenAPI\Client\Model\SelectionAPIOptionResponseDefault[]',
        'order' => 'string',
        'view' => 'string'
    ];
    ...
    public const VIEW_TAGS = 'Tags';
    public const VIEW_LIST_ORDERED = 'ListOrdered';
    public const VIEW_LIST_UNORDERED = 'ListUnordered';
    ...
    public function getViewAllowableValues()
    {
        return [
            self::VIEW_TAGS,
            self::VIEW_LIST_ORDERED,
            self::VIEW_LIST_UNORDERED,
        ];
    }
    ...
    */
     ...
     * Gets options
     *
     * @return \OpenAPI\Client\Model\SelectionAPIOptionResponseDefault[]|null
     */
     ...
     * Sets options
     *
     * @param \OpenAPI\Client\Model\SelectionAPIOptionResponseDefault[]|null $options options
     *
     * @return self
     */
