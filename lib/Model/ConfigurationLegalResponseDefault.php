...
/**
 * ConfigurationLegalResponseDefault Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConfigurationLegalResponseDefault implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'configuration.LegalResponseDefault';
    ...
    */
     ...
     * Sets imprint
     *
     * @param string|null $imprint html formatted string
     *
     * @return self
     */
     ...
     * Sets policy
     *
     * @param string|null $policy html formatted string
     *
     * @return self
     */
