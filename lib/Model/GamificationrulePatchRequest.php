...
/**
 * GamificationrulePatchRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GamificationrulePatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'gamificationrule.PatchRequest';
    ...
    public function setRepetition($repetition)
    {
        ...
        if (!is_null($repetition) && ($repetition < 1)) {
            throw new \InvalidArgumentException('invalid value for $repetition when calling GamificationrulePatchRequest., must be bigger than or equal to 1.');
        }
