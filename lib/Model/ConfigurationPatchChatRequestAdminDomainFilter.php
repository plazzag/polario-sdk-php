...
/**
 * ConfigurationPatchChatRequestAdminDomainFilter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConfigurationPatchChatRequestAdminDomainFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'configuration_PatchChatRequestAdmin_domainFilter';
    ...
    */
    ...
    public function setType($type)
    {
        ...
        if (!is_null($type) && ($type > 3)) {
            throw new \InvalidArgumentException('invalid value for $type when calling ConfigurationPatchChatRequestAdminDomainFilter., must be smaller than or equal to 3.');
        }
        if (!is_null($type) && ($type < 0)) {
            throw new \InvalidArgumentException('invalid value for $type when calling ConfigurationPatchChatRequestAdminDomainFilter., must be bigger than or equal to 0.');
        }
