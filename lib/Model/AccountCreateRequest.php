...
class AccountCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets access
     *
     * @param \OpenAPI\Client\Model\ModelAccess|null $access will be overwritten, when account settings configuration property `visibleForOthers` is false (GET /config/admin/account)
     *
     * @return self
     */
