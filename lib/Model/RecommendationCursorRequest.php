...
/**
 * RecommendationCursorRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecommendationCursorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'recommendation.CursorRequest';
    ...
    protected static $openAPITypes = [
        'filter' => '\OpenAPI\Client\Model\RecommendationCursorFilterOption',
     ...
     * Gets filter
     *
     * @return \OpenAPI\Client\Model\RecommendationCursorFilterOption|null
     */
     ...
     * Sets filter
     *
     * @param \OpenAPI\Client\Model\RecommendationCursorFilterOption|null $filter filter
     *
     * @return self
     */
     ...
     * Sets sort
     *
     * @param array<string,string>[]|null $sort only one property per entry allowed; property enums: `\"matchingPercentage\"` `\"objectId\"`; value enums: `\"ASC\"` `\"DESC\"`
     *
     * @return self
     */
