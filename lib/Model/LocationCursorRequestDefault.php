...
/**
 * LocationCursorRequestDefault Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LocationCursorRequestDefault implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'location.CursorRequestDefault';
    ...
    protected static $openAPITypes = [
        'filter' => '\OpenAPI\Client\Model\LocationCursorFilterOptionDefault',
     ...
     * Gets filter
     *
     * @return \OpenAPI\Client\Model\LocationCursorFilterOptionDefault|null
     */
     ...
     * Sets filter
     *
     * @param \OpenAPI\Client\Model\LocationCursorFilterOptionDefault|null $filter filter
     *
     * @return self
     */
     ...
     * Sets sort
     *
     * @param array<string,string>[]|null $sort only one property per entry allowed; property enums: `\"capacity\"` `\"id\"` `\"lastModified\"` `\"projectId\"` `\"title\"`; value enums: `\"ASC\"` `\"DESC\"`
     *
     * @return self
     */
