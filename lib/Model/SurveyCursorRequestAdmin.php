...
/**
 * SurveyCursorRequestAdmin Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SurveyCursorRequestAdmin implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'survey.CursorRequestAdmin';
    ...
    protected static $openAPITypes = [
        'filter' => '\OpenAPI\Client\Model\SurveyCursorFilterOptionAdmin',
     ...
     * Gets filter
     *
     * @return \OpenAPI\Client\Model\SurveyCursorFilterOptionAdmin|null
     */
     ...
     * Sets filter
     *
     * @param \OpenAPI\Client\Model\SurveyCursorFilterOptionAdmin|null $filter filter
     *
     * @return self
     */
     ...
     * Sets sort
     *
     * @param array<string,string>[]|null $sort only one property per entry allowed; property enums: `\"id\"` `\"lastModified\"` `\"projectId\"`; value enums: `\"ASC\"` `\"DESC\"`
     *
     * @return self
     */
