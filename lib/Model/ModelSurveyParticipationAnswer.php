<?php
/**
 * ModelSurveyParticipationAnswer
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ModelSurveyParticipationAnswer Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelSurveyParticipationAnswer implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'model.SurveyParticipationAnswer';
     ...
     * Sets option_ids
     *
     * @param string[]|null $option_ids only for type Selection
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text only for type Text
     *
     * @return self
     */
