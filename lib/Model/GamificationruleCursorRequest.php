...
/**
 * GamificationruleCursorRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GamificationruleCursorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'gamificationrule.CursorRequest';
    ...
    protected static $openAPITypes = [
        'filter' => '\OpenAPI\Client\Model\GamificationruleCursorFilterOption',
     ...
     * Gets filter
     *
     * @return \OpenAPI\Client\Model\GamificationruleCursorFilterOption|null
     */
     ...
     * Sets filter
     *
     * @param \OpenAPI\Client\Model\GamificationruleCursorFilterOption|null $filter filter
     *
     * @return self
     */
     ...
     * Sets sort
     *
     * @param array<string,string>[]|null $sort only one property per entry allowed; property enums: `\"action\"` `\"id\"` `\"lastModified\"` `\"leaderboardId\"` `\"objectId\"` `\"objectType\"` `\"projectId\"` `\"referenceId\"` `\"repetition\"` `\"value\"`; value enums: `\"ASC\"` `\"DESC\"`
     *
     * @return self
     */
