...
/**
 * ModelPartyBookingSlot Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelPartyBookingSlot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model.PartyBookingSlot';
    ...
    */
     ...
     * Sets date_end
     *
     * @param string|null $date_end Deprecated: will be removed in 6.0; applies to the project time zone
     *
     * @return self
     */
     ...
     * Sets date_start
     *
     * @param string|null $date_start Limit     *int   `bson:\"limit\" json:\"limit\" extensions:\"x-nullable\"`
     *
     * @return self
     */
     ...
     * Sets is_visible
     *
     * @param bool|null $is_visible if false the available booking period should not be displayed
     *
     * @return self
     */
     ...
     * Sets slot_id
     *
     * @param string|null $slot_id slot_id
     *
     * @return self
     */
     ...
     * Sets time_end
     *
     * @param string|null $time_end Deprecated: will be removed in 6.0; applies to the project time zone
     *
     * @return self
     */
     ...
     * Sets time_start
     *
     * @param string|null $time_start Deprecated: will be removed in 6.0; applies to the project time zone
     *
     * @return self
     */
