...
/**
 * ShippingdataCursorRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ShippingdataCursorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'shippingdata.CursorRequest';
    ...
    protected static $openAPITypes = [
        'filter' => '\OpenAPI\Client\Model\ShippingdataCursorFilterOption',
     ...
     * Gets filter
     *
     * @return \OpenAPI\Client\Model\ShippingdataCursorFilterOption|null
     */
     ...
     * Sets filter
     *
     * @param \OpenAPI\Client\Model\ShippingdataCursorFilterOption|null $filter filter
     *
     * @return self
     */
     ...
     * Sets sort
     *
     * @param array<string,string>[]|null $sort only one property per entry allowed; property enums: `\"id\"` `\"shippingId\"`; value enums: `\"ASC\"` `\"DESC\"`
     *
     * @return self
     */
