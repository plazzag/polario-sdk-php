...
*CalendarAdminApi* | [**calendarAdminIdAccessGet**](docs/Api/CalendarAdminApi.md#calendaradminidaccessget) | **GET** /calendar/admin/{id}/access | Get calendar access configuration
*CalendarAdminApi* | [**calendarAdminIdAccessPatch**](docs/Api/CalendarAdminApi.md#calendaradminidaccesspatch) | **PATCH** /calendar/admin/{id}/access | Update calendar access configuration
...
*ConfigAdminApi* | [**configAdminAccountGet**](docs/Api/ConfigAdminApi.md#configadminaccountget) | **GET** /config/admin/account | Get account settings configuration
*ConfigAdminApi* | [**configAdminAccountPatch**](docs/Api/ConfigAdminApi.md#configadminaccountpatch) | **PATCH** /config/admin/account | Update account settings configuration
...
*DirectoryAdminApi* | [**directoryAdminIdAccessGet**](docs/Api/DirectoryAdminApi.md#directoryadminidaccessget) | **GET** /directory/admin/{id}/access | Get directory access configuration
*DirectoryAdminApi* | [**directoryAdminIdAccessPatch**](docs/Api/DirectoryAdminApi.md#directoryadminidaccesspatch) | **PATCH** /directory/admin/{id}/access | Update directory access configuration
...
- [ConfigurationAccountSettingsRequestAdmin](docs/Model/ConfigurationAccountSettingsRequestAdmin.md)
- [ConfigurationAccountSettingsResponseAdmin](docs/Model/ConfigurationAccountSettingsResponseAdmin.md)
...
- [ModelAccountVisibilitySettings](docs/Model/ModelAccountVisibilitySettings.md)
