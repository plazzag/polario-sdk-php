...
------------ | ------------- | ------------- | -------------
**access** | [**\OpenAPI\Client\Model\ModelAccess**](ModelAccess.md) | not for Profile, Support, Imprint, Settings and LeaveProject type | [optional]
...
**children** | [**\OpenAPI\Client\Model\MenuSwagMenuItemAdmin[]**](MenuSwagMenuItemAdmin.md) | only for Folder type | [optional]
...
**url** | **string** | only for Image, Link, Support, Imprint and Settings type | [optional]
