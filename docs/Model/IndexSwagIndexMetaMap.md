...
**capacity** | **int** | only for Locations | [optional]
...
**linked_objects** | [**\OpenAPI\Client\Model\ModelObjectIdentification[]**](ModelObjectIdentification.md) | currently only for Keywords, Locations and MediaImages are linked here | [optional]
